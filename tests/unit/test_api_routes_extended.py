...
from socket_client.services.config_manager import set_config_manager, ConfigManager
...
class TestStreamsAPIEdgeCases:
    ...
    def test_get_streams_empty_list(self, client_extended, mock_config_manager_extended):
